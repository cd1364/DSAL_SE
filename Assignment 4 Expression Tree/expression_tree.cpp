...
Batch : A
Roll no. : 25015
Assignment No. 4 : 4. Expression Tree
*/
...
int main()
{
    ...
    do
    {
        ...
        {
        case 1:
            cout << "Inorder Exp with Recursive => ";
            s.inorder_recursive(s.root);
            break;
        case 2:
            cout << "preorder Exp with Recursive => ";
            s.preorder_recursive(s.root);
            break;
        case 3:
            cout << "postorder Exp with Recursive => ";
            s.postorder_recursive(s.root);
            break;
        case 4:
            cout << "Inorder Exp with Non_Recursive => ";
            s.inorder_nonrecursive(s.root);
            break;
        case 5:
            cout << "preorder Exp with Non_Recursive => ";
            s.preorder_nonrecursive(s.root);
            break;
        case 6:
            cout << "postorder Exp with Non_Recursive => ";
...
ENTER YOUR CHOICE:1
Inorder Exp with Recursive => a+b*c*e

ENTER YOUR CHOICE:2
preorder Exp with Recursive => *+a*bce

ENTER YOUR CHOICE:3
postorder Exp with Recursive => abc*+e*

ENTER YOUR CHOICE:4
Inorder Exp with Non_Recursive => a+b*c*e

ENTER YOUR CHOICE:5
preorder Exp with Non_Recursive => *+a*bce

ENTER YOUR CHOICE:6
postorder Exp with Non_Recursive => abc*+e*
