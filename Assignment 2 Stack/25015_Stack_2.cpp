...
int main()
{
    ...
    while (true)
    {
        ...
        {
        case 1:
            cout << "The postfix conversion of " << infix << " is : " << infix_to_postfix(infix) << endl;
            break;
        case 2:
            cout << "The prefix conversion of " << infix << " is : " << infix_to_prefix(infix) << endl;
            break;
        default:
        ...
        if (choice2 == 1)
        {
            ...
            if (temp == 0)
            {
                cout << "Cannot evaluate the string as it contains alphabets..." << endl;
            }
            else
            {
                switch (choice1)
                {
                case 1:
                    cout << "Value of the expression : " << postfix_eval(infix_to_postfix(infix)) << endl;
                    break;

                case 2:
                    cout << "Value of the expression : " << prefix_eval(infix_to_prefix(infix)) << endl;
                    break;
                }
            }
        }
...
2. Convert entered expression to Prefix
1
The postfix conversion of (a+b)(b+c) is : ab+bc+
Do you wish to evaluate the converted expression?
1. Yes
2. No
1
Cannot evaluate the string as it contains alphabets...
...
2. Convert entered expression to Prefix
1
The postfix conversion of 8+3*9/3 is : 839*3/+
Do you wish to evaluate the converted expression?
1. Yes
2. No
1
...
2. Convert entered expression to Prefix
2
The prefix conversion of 9*3^2+3 is : +*9^323
Do you wish to evaluate the converted expression?
1. Yes
2. No
1
Value of the expression : 75
PRESS 0 TO EXIT & PRESS 1 TO RETURN TO MENU
0
Thank You!!!
*/