...
void display(struct student list[size]){
    ...
    cout<<"\n";
    cout<<"--------------------------------------------------------";
    cout<<"\nSr.No. Roll No. Student Name                      SGPA"<<endl;
    cout<<"--------------------------------------------------------";
    cout<<"\n";
   
    for(int i=0; i<size; i++){
            cout << i+1 <<"\t"<< list[i].roll_no <<"\t"<< list[i].name<<"\t-->>--\t"<< list[i].sgpa <<"\n";
    }
}
...
void view (struct student list[size], int size){
    ...
    for(int j=0; j<size; j++){
            cout << j+1 <<"\t"<< list[j].roll_no <<"\t"<< list[j].name<<"\t-->>--\t"<< list[j].sgpa <<"\n";
    }
}
...
Enter the Name you want to search :CHAITANYA
Name is found at Sr. no. : 4
